...
// This file was copied from the original C library and contains nothing but
// verbatim copies of Microsoft definitions that aren't easily accessible in
// user mode.
// TODO(drivefs-team): Figure out how to get rid of this and use the real stuff.  
...
bool NTAPI RtlIsNameInExpression(UNICODE_STRING* Expression,
                                 UNICODE_STRING* Name,
                                 bool IgnoreCase,
                                 wchar_t* UpcaseTable);

NTSTATUS NTAPI RtlUpcaseUnicodeString(UNICODE_STRING* Destination,
                                      const UNICODE_STRING* Source,
                                      bool AllocateDestination);

NTSTATUS NTAPI RtlFreeUnicodeString(UNICODE_STRING* String);
